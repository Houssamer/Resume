      ...
      <div className="introduction">
        ...
        <div className="introduction_description">
          <p>
            ...
            des travaux public (EHTP) très ambitieux. Je suis très passionné
            dans le domaine de web et la création des applications web. Aussi
            que la gestion et la perfection de code
          </p>
          <br />
          <br />
          <p className="introduction_plus">
            Je suis aussi interessé par la musique, le designe et la
            photographie. Si vous avez des questions à me poser ou vous
            souhaitez se collaborer veuillez me contacter.
          </p>
        </div>
      </div>
      ...
      <div className="projects">
        ...
        <div className="projects_description">
          <div className="projects_detaille">
            <a
              href="https://github.com/Houssamer/paid-cation"
              target="_blank"
              rel="noreferrer"
            >
              <h4>PAID-cation: </h4>
            ...
            <a
              href="http://stage.riadhoussame.tk"
              target="_blank"
              rel="noreferrer"
              id="stage"
            >
              <p>stage.riadhoussame.tk</p>
            </a>
            <div className="description">
              <p>
                Une application de réservation des espaces de travail où vous
                pouvez annoncer votre espace ou réserver un. (Projet de stage)
              </p>
            </div>
          </div>
          <div className="projects_detaille">
            <a
              href="https://github.com/Houssamer/Tinder-clone-front-end"
              target="_blank"
              rel="noreferrer"
            >
              <h4>Tinder-clone: </h4>
          ...
          <div className="projects_detaille">
            <a
              href="https://github.com/Houssamer/amazon-clone"
              target="_blank"
              rel="noreferrer"
            >
              <h4>Amazon-clone: </h4>
            ...
            <div className="description">
              <p>
                Un clone de Amazon avec l'authentification. et plus de
                fonctionnalités comme ajouter ou panier et la gestion des states
                avec REDUX.
              </p>
            </div>
          </div>
          <div className="projects_detaille">
            <a
              href="https://github.com/Houssamer/uber-clone-clientSide"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <div className="description">
              <p>
                Un clone de l'application Uber avec la geolocalisation et
                l'application driver aussi que client.
              </p>
            </div>
          </div>
        </div>
